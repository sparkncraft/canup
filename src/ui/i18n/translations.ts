...
const translations: Record<string, Record<string, string>> = {
  ar: {
    ...
    'canup.creditCounter.upgradeForMore':
      'ترقية للحصول على المزيد من الأرصدة',
    'canup.creditCounter.exhausted': 'لم يتبقَّ لديك أرصدة كافية.',
    'canup.creditCounter.exhaustedRefresh':
      'يتم تجديد الأرصدة في {resetDate}.',
  ...
  de: {
    ...
    'canup.creditCounter.exhausted':
      'Du hast nicht genügend Credits übrig.',
    'canup.creditCounter.exhaustedRefresh':
      'Credits werden am {resetDate} erneuert.',
    'canup.creditCounter.usage':
  ...
  es: {
    ...
    'canup.creditCounter.upgradeForMore':
      'Actualiza para obtener más créditos',
    'canup.creditCounter.exhausted': 'No te quedan suficientes créditos.',
    'canup.creditCounter.exhaustedRefresh':
      'Los créditos se renuevan el {resetDate}.',
    'canup.creditCounter.usage':
  ...
  fr: {
    'canup.creditCounter.loggedInAs':
      'Vous êtes connecté(e) en tant que {email}.',
    'canup.creditCounter.manageSubscription': "Gérer l'abonnement",
    'canup.creditCounter.upgradeForMore':
      'Passez au niveau supérieur pour plus de crédits',
    'canup.creditCounter.exhausted':
      "Vous n'avez plus assez de crédits.",
    'canup.creditCounter.exhaustedRefresh':
      'Les crédits se renouvellent le {resetDate}.',
    'canup.creditCounter.usage':
  ...
  id: {
    ...
    'canup.creditCounter.exhaustedRefresh':
      'Kredit diperbarui pada {resetDate}.',
    'canup.creditCounter.usage':
  ...
  it: {
    'canup.creditCounter.loggedInAs':
      "Hai effettuato l'accesso come {email}.",
    'canup.creditCounter.manageSubscription': 'Gestisci abbonamento',
    'canup.creditCounter.upgradeForMore':
      "Effettua l'upgrade per ottenere più crediti",
    'canup.creditCounter.exhausted':
      'Non ti restano crediti a sufficienza.',
    'canup.creditCounter.exhaustedRefresh':
      'I crediti si rinnovano il {resetDate}.',
    'canup.creditCounter.usage':
  ...
  ms: {
    ...
    'canup.creditCounter.upgradeForMore':
      'Naik taraf untuk lebih banyak kredit',
    'canup.creditCounter.exhausted':
      'Anda tidak mempunyai kredit yang mencukupi.',
    'canup.creditCounter.exhaustedRefresh':
      'Kredit diperbaharui pada {resetDate}.',
    'canup.creditCounter.usage':
  ...
  nl: {
    ...
    'canup.creditCounter.exhausted':
      'Je hebt niet genoeg credits over.',
    'canup.creditCounter.exhaustedRefresh':
      'Credits worden vernieuwd op {resetDate}.',
    'canup.creditCounter.usage':
  ...
  pl: {
    ...
    'canup.creditCounter.upgradeForMore':
      'Ulepsz plan, aby uzyskać więcej kredytów',
    'canup.creditCounter.exhausted':
      'Nie masz wystarczającej liczby kredytów.',
    'canup.creditCounter.exhaustedRefresh':
      'Kredyty odnowią się {resetDate}.',
    'canup.creditCounter.usage':
  ...
  'pt-BR': {
    'canup.creditCounter.loggedInAs':
      'Você está conectado(a) como {email}.',
    ...
    'canup.creditCounter.exhaustedRefresh':
      'Os créditos são renovados em {resetDate}.',
    'canup.creditCounter.usage':
  ...
  ro: {
    ...
    'canup.creditCounter.upgradeForMore':
      'Fă upgrade pentru mai multe credite',
    'canup.creditCounter.exhausted': 'Nu mai ai suficiente credite.',
    'canup.creditCounter.exhaustedRefresh':
      'Creditele se reîmprospătează pe {resetDate}.',
    'canup.creditCounter.usage':
  ...
  sv: {
    ...
    'canup.creditCounter.exhausted':
      'Du har inte tillräckligt med krediter kvar.',
    'canup.creditCounter.exhaustedRefresh':
      'Krediter förnyas den {resetDate}.',
    'canup.creditCounter.usage':
  ...
  th: {
    ...
    'canup.creditCounter.exhaustedRefresh':
      'เครดิตจะรีเซ็ตในวันที่ {resetDate}',
    'canup.creditCounter.usage':
      'ใช้ไปแล้ว {used} จาก {quota} {used, plural, other {เครดิต}}',
    'canup.creditCounter.refreshInterval':
  ...
  tr: {
    ...
    'canup.creditCounter.upgradeForMore':
      'Daha fazla kredi için yükseltin',
    'canup.creditCounter.exhausted': 'Yeterli krediniz kalmadı.',
    'canup.creditCounter.exhaustedRefresh':
      'Krediler {resetDate} tarihinde yenilenir.',
    'canup.creditCounter.usage':
  ...
  vi: {
    ...
    'canup.creditCounter.upgradeForMore':
      'Nâng cấp để có thêm tín dụng',
    'canup.creditCounter.exhausted': 'Bạn không còn đủ tín dụng.',
    'canup.creditCounter.exhaustedRefresh':
      'Tín dụng được làm mới vào {resetDate}.',
    'canup.creditCounter.usage':
