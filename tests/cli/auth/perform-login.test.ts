...
import { test, output, client, tokenStore } from '../../fixtures/cli.js';
...
vi.mock('../../../src/cli/auth/oauth-server.js', () => ({
...
describe('performLogin', () => {
  test('completes happy path: saves token, closes server, returns token', async ({ client }) => {
    ...
    const { performLogin } = await import('../../../src/cli/auth/perform-login.js');
